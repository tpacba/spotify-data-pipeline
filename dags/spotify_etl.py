...
def run_spotify_etl():
    database_location = "sqlite:///played_tracks.sqlite"
    unformat_token = "BQDHcn_TKJ9ipmfDGmVGtSrhv89n_Ppbo53FfP-0yopanN8klQzTbTutU4jMxyE7gNHLqt7ZEEPeAmJYDskpx0lr_IvreI4Fo29JjGg7AKn9kVaeLlklCmzJOqeEqXt8_UdA_TkfCYE0xJMFj_oHxA"


    headers = {
        "Accept": "application/json",
        "Content-Type": "application/json",
        "Authorization": "Bearer {token}".format(token=unformat_token)
    }
